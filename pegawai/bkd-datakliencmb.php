    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../pegawai/bkd-datakliencmb.php">Tambah Data Klien</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="mainpage">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php if (isset($_POST['simpan'])) {
                ...
                $sql = pg_query(
                    $conn,
                    "insert into litmas (id_litmas,id_jenis_litmas,nip,id_jenis_klien,id_status,id_lapas,id_kasus,nama_klien) values ('$id_litmas', 3 ,'$pkk', 2 , '$statuss', '$lapass', '$kasuss', '$nama_klien')"
                );
                if ($sql) { ?>
                echo "<script>
                  alert('Data berhasil ditambah');
                  window.location = '../pegawai/bkd-cuti menjelang bebas.php';
                </script>";
            <?php }
            } ?>
