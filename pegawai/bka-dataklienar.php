...
<head>
    ...
    <title>BKA DataklienAR (PEGAWAI)- Bapas Pekanbaru</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../pegawai/bka-asimilasi rumah.php">Asimilasi Rumah</a></li>
          <li class="breadcrumb-item"><a href="../pegawai/bka-dataklienar.php">Tambah Data Klien</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="mainpage">
        ...
        <div class="row">
          <div class="col-lg-12">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer ">
                                  <div>
                                    <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../pegawai/bka-dataklienar.php">
                                  </div>
                                  <div>
            ...
            <?php if (isset($_POST['simpan'])) {
              ...
              $sql = mysqli_query(
                $conn,
                "insert into litmas (id_litmas,id_jenis_litmas,nip,id_jenis_klien,id_status,id_lapas,id_kasus,nama_klien) values ('$id_litmas', 4 ,'$pkk', 1 , '$statuss', '$lapass', '$kasuss', '$nama_klien')"
              );
              if ($sql) { ?>
                echo "<script>
                  alert('Data berhasil ditambah');
                  window.location = '../pegawai/bka-asimilasi rumah.php';
                </script>";
            <?php }
            } ?>
