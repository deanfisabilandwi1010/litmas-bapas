...
<head>
  ...
  if ($_SESSION['status'] == 'login') { ?>
    ...
    <title>BKA PB (Pegawai) - Bapas Pekanbaru</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <a class="btn btn-primary" href="../pegawai/bka-dataklienpb.php" style="float: right;" role="button">+</a>
    <div>
          ...
          while ($row = pg_fetch_array($result)) {
            ...
            <tr align="center">
              ...
              <td>
                ...
                <div class="con">
                  <a class="bi bi-pencil-square bg-icon-primary " href="../pegawai/bka-statuspb.php?id_litmas=<?= $row[
                      'id_litmas'
