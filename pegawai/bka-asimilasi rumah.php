...
<head>
  ...
  if ($_SESSION['status'] == 'login') { ?>
    ...
    <title>BKA AR (Pegawai)- Bapas Pekanbaru</title>
...
<a href="../pegawai/dashboard.php" class="logo d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <a class="btn btn-primary" href="../pegawai/bka-dataklienar.php" style="float: right;" role="button">+</a>
    <div>
      <table class="table" id="table">
        ...
        <tbody>
          ...
          $result5 = pg_query(
              $conn,
              'SELECT nama_status_litmas FROM status_litmas INNER JOIN litmas ON status_litmas.id_status = litmas.id_status WHERE id_jenis_litmas = 4 AND id_jenis_klien= 1 ORDER BY id_litmas ASC'
          );
          ...
          while ($row = pg_fetch_array($result)) {
            ...
            <tr align="center">
              ...
              <td>
                ...
                <div class="con">
                  <a class="bi bi-pencil-square bg-icon-primary " href="../pegawai/bka-statusar.php?id_litmas=<?= $row[
                      'id_litmas'
