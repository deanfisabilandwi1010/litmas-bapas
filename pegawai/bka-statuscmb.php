...
<head>
        ...
        <title>BKA Status CMB (PEGAWAI) - Bapas Pekanbaru</title>
...
<body>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../pegawai/bka-statuscmb.php">Ubah Status Klien</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <div class="mainpage">
    ...
    echo 'selected';
            ...
            <?php if (isset($_POST['simpan'])) {
                ...
                if ($sql) {
                    echo "<script>alert('Data berhasil diedit');window.location='../pegawai/bka-cuti menjelang bebas.php';</script>";
                } else {
