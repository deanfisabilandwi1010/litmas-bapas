...
<head>
  ...
  if ($_SESSION['status'] == 'login') { ?>
    ...
    <title>BKA Sidang (Pegawai)- Bapas Pekanbaru</title>
...
<a href="../pegawai/dashboard.php" class="logo d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <a class="btn btn-primary" href="../pegawai/bka-datakliensidang.php" style="float: right;" role="button">+</a>
    <div>
          ...
          while ($row = pg_fetch_array($result)) {
            ...
            <tr align="center">
              ...
              <td>
                ...
                <div class="con">
                  <a class="bi bi-pencil-square bg-icon-primary " href="../pegawai/bka-statussidang.php?id_litmas=<?= $row[
                      'id_litmas'
