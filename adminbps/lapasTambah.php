...
$query = mysqli_query($conn, "SELECT MAX(id_lapas) as max_lapas FROM lapas");
...
<head>
        ...
        <title>Tambah UPT (ADMIN)- Bapas Pekanbaru</title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../adminbps/lapasTambah.php">Tambah Tempat Asal</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <div class="mainpage">
            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Silahkan Masukkan Data Tempat Asal Baru</h5>
                                ...
                                <form method="POST">
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="id_lapas" value="<?php echo $id ?>" readonly>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nama_lapas">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row mb-6">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer ">
                                                                <div>
                                                                    <input type="submit" name="simpan" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/lapasTambah.php">
                                                                </div>
                                                                <div>
            ...
            <?php if (isset($_POST['simpan'])) {
                ...
                $sql = mysqli_query($conn, "INSERT INTO lapas (id_lapas,nama_lapas,alamat) values ('$id_lapas','$nama_lapas', '$alamat')");

                if ($sql) {
                    echo "<script>alert('Data berhasil ditambah');window.location='../adminbps/lapas.php';</script>";
                } else {
