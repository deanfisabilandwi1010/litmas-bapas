...
<head>
    ...
    <title>BKD Status PB (ADMIN) - Bapas Pekanbaru</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../adminbps/bkd-statuspb.php">Ubah Status Klien</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="mainpage">
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-sm-10">
                      <select style="padding:5px 10px; width:100%;" class="chosen-select" data-placeholder="Pilih UPT Asal" name="lapas" required>
                        ...
                        <?php
                        include '../connect.php';
                        $lapas = mysqli_query($conn, "SELECT * FROM lapas ORDER BY nama_lapas ASC");
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-sm-10">
                      <select style="padding:5px 10px; width:100%;" class="chosen-select" data-placeholder="Pilih PK Klien" name="pk" required>
                        ...
                        <?php
                        include '../connect.php';
                        $nip = mysqli_query($conn, "select * from pegawai order by nama_pegawai ASC");
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-sm-10">
                      <select style="padding:5px 10px; width:100%;" class="chosen-select" data-placeholder="Pilih Jenis Kasus" name="kasus" required>
                        ...
                        <?php
                        include '../connect.php';
                        $kasus = mysqli_query($conn, "select * from kasus order by jenis_kasus ASC");
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-sm-10">
                      <select style="padding:5px 10px; width:100%;" class="chosen-select" data-placeholder="Pilih Status Klien" name="status" required>
                        ...
                        <?php
                        include '../connect.php';
                        $status = mysqli_query($conn, "select * from status_litmas order by id_status ASC");
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer ">
                                  <div>
                                    <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bkd-statuspb.php">
                                  </div>
                                  <div>
      ...
      <?php if (isset($_POST['simpan'])) {
        ...
        $sql = mysqli_query($conn, "UPDATE litmas SET id_litmas = '$id_litmas', nama_klien = '$nama_klien', nip='$pkk', id_kasus='$kasuss', id_lapas='$lapass', id_status='$statuss' WHERE id_litmas = '$id_litmas'");

        if ($sql) {
          echo "<script>alert('Data berhasil diedit');window.location='../adminbps/bkd-pembebasan bersyarat.php';</script>";
        } else {
