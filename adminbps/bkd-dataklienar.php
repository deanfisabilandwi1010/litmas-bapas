...
<head>
  ...
  <title>BKD DataklienAR (ADMIN)- Bapas Pekanbaru</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../adminbps/bkd-dataklienar.php">Tambah Data Klien</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="mainpage">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer ">
                                  <div>
                                    <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bkd-dataklienar.php">
                                  </div>
                                  <div>
