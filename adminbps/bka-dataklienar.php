                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer ">
                                      <div>
                                        <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bka-dataklienar.php">
                                      </div>
                                      <div>
          ...
          <?php if (isset($_POST['simpan'])) {
            ...
            if ($sql) { ?>
              echo "<script>
                ...
                window.location = '../adminbps/bka-asimilasi rumah.php';
              </script>";
          <?php }
          } ?>
        </div>
