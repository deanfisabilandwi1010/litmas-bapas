...
<head>
  ...
  <title>BKA Statuscmb (ADMIN) - Bapas Pekanbaru</title>
  ...
  <main id="main" class="main">
    ...
    <div class="mainpage">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer ">
                                  <div>
                                    <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/statuscmb.php">
                                  </div>
                                  <div>
      ...
      <?php if (isset($_POST['simpan'])) {
        ...
        if ($sql) {
          echo "<script>alert('Data berhasil diedit');window.location='../adminbps/bka-cuti menjelang bebas.php';</script>";
        } else {
