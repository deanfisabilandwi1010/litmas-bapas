...
<head>
  ...
  if ($_SESSION['status'] == 'login') { ?>
    ...
    <title>BKA DataklienCMB (ADMIN)- Bapas Pekanbaru</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../adminbps/bka-datakliencmb.php">Tambah Data Klien</a></li>
        </ol>
      </nav>
    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer ">
                                      <div>
                                        <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bka-datakliencmb">
                                      </div>
                                      <div>
          ...
          <?php if (isset($_POST['simpan'])) {
            ...
            if ($sql) { ?>
              echo "<script>
                ...
                window.location = '../adminbps/bka-cuti menjelang bebas.php';
              </script>";
          <?php }
          } ?>
        </div>
