    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../adminbps/bkd-statuscb.php">Ubah Status Klien</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="mainpage">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer ">
                                  <div>
                                    <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bkd-statuscb.php">
                                  </div>
                                  <div>
      ...
      <?php if (isset($_POST['simpan'])) {
        ...
        if ($sql) {
          echo "<script>alert('Data berhasil diedit');window.location='../adminbps/bkd-cuti bersyarat.php';</script>";
        } else {
