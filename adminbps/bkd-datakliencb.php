...
<head>
    ...
    <title>BKD DataklienCB (ADMIN)- Bapas Pekanbaru</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../adminbps/bkd-datakliencb.php">Tambah Data Klien</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="mainpage">
        ...
        <div class="row">
          <div class="col-lg-12">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer ">
                                  <div>
                                    <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bkd-datakliencb.php">
                                  </div>
                                  <div>
            ...
            if (isset($_POST['simpan'])) {
              ...
              $sql = mysqli_query($conn, "insert into litmas (id_litmas,id_jenis_litmas,nip,id_jenis_klien,id_status,id_lapas,id_kasus,nama_klien) values ('$id_litmas', 1 ,'$pkk', 2 , '$statuss', '$lapass', '$kasuss', '$nama_klien')");
              if ($sql) {
            ?>
                echo "<script>
                  alert('Data berhasil ditambah');
                  window.location = '../adminbps/bkd-cuti bersyarat.php';
                </script>";
            <?php
              }
            }
