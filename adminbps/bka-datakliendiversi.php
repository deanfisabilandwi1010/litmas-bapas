...
<head>
  ...
  <title>BKA Datakliendiversi (ADMIN)- Bapas Pekanbaru</title>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer ">
                                      <div>
                                        <input type="submit" name="tolak" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../adminbps/bka-datakliendiversi.php">
                                      </div>
                                      <div>
